...
class test_GraphAlgo(unittest.TestCase):
    ...
    def test_is_connected(self):
        self.g.load_from_json("../data/CompleteG.json")
        self.assertTrue(self.g.is_connected())
        self.g.load_from_json("../data/MyG.json")
        self.assertTrue(self.g.is_connected())
        self.g.load_from_json("../data/G1.json")
        self.assertTrue(self.g.is_connected())
        self.g.load_from_json("../data/G2.json")
        self.assertTrue(self.g.is_connected())
        self.g.load_from_json("../data/G3.json")
        self.assertTrue(self.g.is_connected())
        self.g.load_from_json("../data/1000Nodes.json")
        self.assertTrue(self.g.is_connected())
        # 1 is not connected
        self.g.load_from_json("../data/NotConnectedG.json")
        self.assertFalse(self.g.is_connected())
        # 47 is not connected
        self.g.load_from_json("../data/NotConnectedG2.json")
        self.assertFalse(self.g.is_connected())
